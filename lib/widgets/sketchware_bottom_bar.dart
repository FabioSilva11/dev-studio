...
class SketchwareBottomBar extends StatefulWidget {
  const SketchwareBottomBar({
    super.key,
  ...
  @override
  State<SketchwareBottomBar> createState() => _SketchwareBottomBarState();
}

class _SketchwareBottomBarState extends State<SketchwareBottomBar> {
